...
> 版本：v0.1.2 | 日期：2026-05-01 | 状态：ACTIVE-DRAFT
> 上游治理：tzhOS `ai/JUDGMENT-HARNESS.md` v0.1.3 / AI-R0005
...
| `method_version` | 是 | Judgment Harness 方法版本，例如 `v0.1.3` |
