...
**P4a — 验证即完成门禁**：声称完成但未附带新鲜验证证据 = 无效声明。禁止在验证前使用"应该能通过" / "大概" / "看起来" / "完成了！"等措辞。详见 `anti-rationalization.md`。

**P4b — 反合理化**：每个门禁场景配备"常见跳过借口反驳表"和"Red Flags 自检列表"。Agent 在想跳过流程时必须先对照 Red Flags 自检。详见 `anti-rationalization.md`。
